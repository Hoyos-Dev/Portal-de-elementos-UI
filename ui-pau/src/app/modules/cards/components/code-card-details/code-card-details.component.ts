...
@Component({
  selector: 'app-code-card-details',
  templateUrl: './code-card-details.component.html',
  styleUrls: ['./code-card-details.component.scss']
})
export class CodeCardDetailsComponent {
  from: string = '';
  tabs: any[] = [];
  ...
  constructor(
    ...
    this.codeService.getExample('code-card-details').subscribe(data => {
      this.tabs = [
