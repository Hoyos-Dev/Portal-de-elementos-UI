...
@Component({
  selector: 'app-code-card-details-images',
  templateUrl: './code-card-details-images.component.html',
  styleUrls: ['./code-card-details-images.component.scss']
})
export class CodeCardDetailsImagesComponent {
  from: string = '';
  tabs: any[] = [];
  ...
  constructor(
    ...
    this.codeService.getExample('code-card-details-images').subscribe(data => {
      this.tabs = [
