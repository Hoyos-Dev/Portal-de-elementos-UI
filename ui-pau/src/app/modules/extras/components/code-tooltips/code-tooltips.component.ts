...
@Component({
  selector: 'app-code-tooltips',
  templateUrl: './code-tooltips.component.html',
  styleUrls: ['./code-tooltips.component.scss']
})
export class CodeTooltipsComponent {
  from: string = '';
  tabs: any[] = [];
  ...
  constructor(
    ...
    this.codeService.getExample('code-tooltips').subscribe(data => {
      this.tabs = [
