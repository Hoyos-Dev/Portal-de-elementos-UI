...
@Component({
  selector: 'app-code-alert-error',
  templateUrl: './code-alert-error.component.html',
  styleUrls: ['./code-alert-error.component.scss']
})
export class CodeAlertErrorComponent {
  from: string = '';
  tabs: any[] = [];
  ...
  constructor(
    ...
    this.codeService.getExample('code-alert-error').subscribe(data => {
      this.tabs = [
