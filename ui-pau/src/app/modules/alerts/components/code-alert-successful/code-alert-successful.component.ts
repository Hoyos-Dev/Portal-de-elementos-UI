...
@Component({
  selector: 'app-code-alert-successful',
  templateUrl: './code-alert-successful.component.html',
  styleUrls: ['./code-alert-successful.component.scss']
})
export class CodeAlertSuccessfulComponent {
  from: string = '';
  tabs: any[] = [];
  ...
  constructor(
    ...
    this.codeService.getExample('code-alert-successful').subscribe(data => {
      this.tabs = [
