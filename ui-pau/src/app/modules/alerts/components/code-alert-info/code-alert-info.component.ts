...
@Component({
  selector: 'app-code-alert-info',
  templateUrl: './code-alert-info.component.html',
  styleUrls: ['./code-alert-info.component.scss']
})
export class CodeAlertInfoComponent {
  from: string = '';
  tabs: any[] = [];
  ...
  constructor(
    ...
    this.codeService.getExample('code-alert-info').subscribe(data => {
      this.tabs = [
