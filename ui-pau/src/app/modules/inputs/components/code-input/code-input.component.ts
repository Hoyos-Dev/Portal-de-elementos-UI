...
export class CodeInputComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-input').subscribe(data => {
      console.log('data recibido en code-input:', data, 'data.icons:', data.icons, 'data.icons.html:', data.icons?.html);
      this.tabs = [
