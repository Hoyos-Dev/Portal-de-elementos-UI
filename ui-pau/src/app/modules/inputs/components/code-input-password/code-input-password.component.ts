...
@Component({
  selector: 'app-code-input-password',
  templateUrl: './code-input-password.component.html',
  styleUrls: ['./code-input-password.component.scss']
})
export class CodeInputPasswordComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-input-password').subscribe(data => {
      this.tabs = [
