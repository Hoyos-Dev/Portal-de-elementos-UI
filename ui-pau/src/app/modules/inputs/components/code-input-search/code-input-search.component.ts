...
@Component({
  selector: 'app-code-input-search',
  templateUrl: './code-input-search.component.html',
  styleUrls: ['./code-input-search.component.scss']
})
export class CodeInputSearchComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-input-search').subscribe(data => {
      this.tabs = [
