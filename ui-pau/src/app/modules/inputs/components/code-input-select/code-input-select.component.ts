...
@Component({
  selector: 'app-code-input-select',
  templateUrl: './code-input-select.component.html',
  styleUrls: ['./code-input-select.component.scss']
})
export class CodeInputSelectComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-input-select').subscribe(data => {
      this.tabs = [
