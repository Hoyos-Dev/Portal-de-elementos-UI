...
@Component({
  selector: 'app-code-button-plus-icon',
  templateUrl: './code-button-plus-icon.component.html',
  styleUrls: ['./code-button-plus-icon.component.scss']
})
export class CodeButtonPlusIconComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-button-plus-icon').subscribe(data => {
      this.tabs = [
