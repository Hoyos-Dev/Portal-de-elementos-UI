...
@Component({
  selector: 'app-code-disabled-button',
  templateUrl: './code-disabled-button.component.html',
  styleUrls: ['./code-disabled-button.component.scss']
})
export class CodeDisabledButtonComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-disabled-button').subscribe(data => {
      this.tabs = [
