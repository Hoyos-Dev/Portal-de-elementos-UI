...
@Component({
  selector: 'app-code-primary-buttons',
  templateUrl: './code-primary-button.component.html',
  styleUrls: ['./code-primary-button.component.scss']
})
export class CodePrimaryButtonComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-primary-button').subscribe(data => {
      this.tabs = [
  ...
  copiarCodigo() {
    // Copia el código del tab seleccionado
