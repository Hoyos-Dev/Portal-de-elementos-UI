...
@Component({
  selector: 'app-code-expanded-button',
  templateUrl: './code-expanded-button.component.html',
  styleUrls: ['./code-expanded-button.component.scss']
})
export class CodeExpandedButtonComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.codeService.getExample('code-expanded-button').subscribe(data => {
      this.tabs = [
